...
var jump_sound = preload("res://assets/audio/jump_sound.mp3")
...
func update_hud():
	...
	if hud == null:
		return
	var hp_label = hud.find_child("HPLabel", true, false)
	var lives_label = hud.find_child("LivesLabel", true, false)
	var level_label = hud.find_child("LevelLabel", true, false)
	var timer_label = hud.find_child("TimerLabel", true, false)
	var score_label = hud.find_child("ScoreLabel", true, false)
